...
In order to conduct comprehensive testing of the individual units, we could create an artificial playlist that meets our future constraints in order to test the functionality of the code created that is complied with the use of Spotify API. 
